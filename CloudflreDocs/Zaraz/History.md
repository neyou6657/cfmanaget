...
Zaraz EditZaraz Admin
Parameters
params
ZarazUpdateParams
ZoneIDparam.Field[string]
(maxLength: 32)
...
Returns
Workflow
constWorkflowRealtime
Workflow
 = "realtime"
constWorkflowPreview
Workflow
 = "preview"
Request example Go
package main
...
import (
	...
	"github.com/cloudflare/cloudflare-go/v3/zaraz"
)
...
func main() {
	...
	workflow, err := client.Zaraz.Update(context.TODO(), zaraz.ZarazUpdateParams{
