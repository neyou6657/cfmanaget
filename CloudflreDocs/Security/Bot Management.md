...
BotManagement
Methods
client.BotManagement.Get(ctx, query) (*
BotManagementGetResponse
, error)
get/zones/{zone_id}/bot_management
Retrieve a zone's Bot Management Config
client.BotManagement.Update(ctx, params) (*
...
It is strongly recommended that you ensure you have custom rules in place to protect your zone before disabling the SBFM rules. Without these protections, your zone is vulnerable to attacks.
{
  ...
  "fight_mode": false}
Domain types
typeBotFightModeConfigurationstruct{…}
typeSubscriptionConfigurationstruct{…}
typeSuperBotFightModeDefinitelyConfigurationstruct{…}
typeSuperBotFightModeLikelyConfigurationstruct{…}